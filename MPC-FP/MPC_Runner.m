%Script that runs the MPC_Simulator Function for Fixed-Point Analysis
...
ref_0 = ones(1,T) * 2.12; %2.12V needed to control tank at 15cm
ref_1 = ones(1,T) * 2.12; 

ref_0(201:600) = ref_0(201:600) - 0.5*ref_0(201:600); 
...
% --------------Run Model--------------------------
[y_t,u_t] = MPC_Simulator(ref_0,ref_1,noise,T,H,q_,E,F1,z_min,z_max,n,m,N_h,A_d,B_d,C_d,Aob,Bob,Cob,Ld); 
