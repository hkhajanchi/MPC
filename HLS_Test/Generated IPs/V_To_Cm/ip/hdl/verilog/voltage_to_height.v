...
input   ap_clk;
input   ap_rst;
input  [15:0] voltage_V;
output  [15:0] height_V;
output   height_V_ap_vld;
...
voltage_to_heightbkb #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 16 ),
    .din1_WIDTH( 12 ),
    .dout_WIDTH( 28 ))
voltage_to_heightbkb_U1(
    .din0(voltage_V),
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        height_V_ap_vld = 1'b1;
    end else begin
        height_V_ap_vld = 1'b0;
    end
end
...
assign height_V = (p_Val2_1_reg_84 + tmp_4_fu_67_p1);

assign p_Val2_s_fu_76_p1 = 28'd1830;

assign tmp_4_fu_67_p1 = tmp_reg_89;

endmodule //voltage_to_height
